...
bot = telebot.TeleBot('7310628686:AAE3j-6m0KR8lwD4PbI1VjeuUyfCX9milVA')
# Admin user IDs
admin_id = {"5344691638"}
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"🚀 𝗔𝘁𝘁𝗮𝗰𝗸 𝗦𝗲𝗻𝘁 𝗦𝘂𝗰𝗰𝗲𝘀𝘀𝗳𝘂𝗹𝗹𝘆! 🚀\n\n𝗧𝗮𝗿𝗴𝗲𝘁: {target}:{port}\n𝗔𝘁𝘁𝗮𝗰𝗸 𝗧𝗶𝗺𝗲: {time} seconds\n᚛ 𝙎𝘼𝙉𝘿 𝙁𝙀𝙀𝘿𝘽𝘼𝘾𝙆 𝙀𝙇𝙎𝙀 𝙍𝘼𝙉𝘿𝙄 ⚠️ ᚜"
    bot.reply_to(message, response)
...
def welcome_start(message):
    ...
    response = f'''𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝙳𝙰𝚁𝙺-𝙳𝙳𝙾𝚂𝙴-𝙱𝙾𝚃!\n1. /bgmi \n2. /help\n3. /plan\n4. /rules\n𝐃𝐌 𝐅𝐎𝐑 𝐊𝐄𝐘👇👇\nhttps://t.me/RitikXyz099
